	...
	class DCC_Customizer_Loader {
		...
		function dcc_customize_register( $wp_customize ) {
			...
			$wp_customize->add_setting( 'dcc_content', array(
				'default'   => __( 'This site uses cookies. By continuing to use this website, you agree to their use. For details, please check our <a href="#">Privacy Policy</a>', 'divi-cookie-consent' ),
				'type'      => 'option'
				)
			);
